...
-- Drop admin schema and move tables to public
...
-- Create new policies
-- Allow anonymous users to insert audit logs (needed for login)
...
-- Drop problematic triggers that might interfere with login
